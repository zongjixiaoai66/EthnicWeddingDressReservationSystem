...
var centerMenu = [
    ...
    ,{
        name: '摄影师收藏',
        url: '../sheyingshiCollection/list.html'
    }
    ,{
        name: '摄影师预约',
        url: '../sheyingshiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '摄影师',
        url: './pages/sheyingshi/list.html'
    },

]

var adminurl =  "http://localhost:8080/minzuhunshayudingxitong/admin/dist/index.html#/login";
