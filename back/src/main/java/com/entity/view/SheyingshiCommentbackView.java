...
public class SheyingshiCommentbackView extends SheyingshiCommentbackEntity implements Serializable {
	...
	public SheyingshiCommentbackView() {

	}

	public SheyingshiCommentbackView(SheyingshiCommentbackEntity sheyingshiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, sheyingshiCommentbackEntity);
