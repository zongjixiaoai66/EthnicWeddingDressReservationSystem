...
public class SheyingshiCollectionView extends SheyingshiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String sheyingshiCollectionValue;
	...
	public SheyingshiCollectionView() {

	}

	public SheyingshiCollectionView(SheyingshiCollectionEntity sheyingshiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, sheyingshiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getSheyingshiCollectionValue() {
				return sheyingshiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setSheyingshiCollectionValue(String sheyingshiCollectionValue) {
				this.sheyingshiCollectionValue = sheyingshiCollectionValue;
			}
