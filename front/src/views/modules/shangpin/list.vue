            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '作品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="作品名称" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '作品编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinUuidNumber" placeholder="作品编号" clearable></el-input>
                     </el-form-item>
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '作品类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择作品类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/minzuhunshayudingxitong/upload/shangpinMuBan.xls"
                        >批量导入作品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
